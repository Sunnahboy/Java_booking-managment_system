...
public class ExtraAdminManager {
    ...
    public void createUser(User user) throws InvalidInputException {
        ...
        switch (idPrefix) {
            ...
            case "C":
                ...
                break;
            default:
                throw new InvalidInputException("Invalid user ID prefix. Must start with M (Manager), S (Scheduler), or C (Customer).");
        }
    ...
    // Edit user without changing the user type
    ...
    // Helper: update user status (block/unblock)
